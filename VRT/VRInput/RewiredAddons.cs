...
namespace VRMaker
{
    internal static class RewiredAddons
    {
        ...
        {
            Logs.WriteInfo("CreateReWiredController() start");
            HardwareControllerMap_Game hcMap = new HardwareControllerMap_Game(
                ...
                {
                    new HardwareAxisInfo(AxisCoordinateMode.Absolute, false, 0.0f, SpecialAxisType.None),
                    new HardwareAxisInfo(AxisCoordinateMode.Absolute, false, 0.0f, SpecialAxisType.None),
                    new HardwareAxisInfo(AxisCoordinateMode.Absolute, false, 0.0f, SpecialAxisType.None),
                    new HardwareAxisInfo(AxisCoordinateMode.Absolute, false, 0.0f, SpecialAxisType.None),
                    new HardwareAxisInfo(AxisCoordinateMode.Absolute, false, 0.0f, SpecialAxisType.None),  //analog trigger
                    new HardwareAxisInfo(AxisCoordinateMode.Absolute, false, 0.0f, SpecialAxisType.None)  //analog trigger
                },
            ...
            Logs.WriteInfo("Finished hcMap constructor");
            ...
            Logs.WriteInfo("newController successfully created: ");
            Logs.WriteInfo(newController.ToString());
            ...
            Logs.WriteInfo("CreateReWiredController() end");
        ...
        private static CustomControllerMap CreateCustomMap(string mapName, int categoryId, int controllerId, List<ActionElementMap> actionElementMaps)
        {
            ...
            return ReInput.UserData.FOpnPAIEvAFTsdbpngFJvcNiJQaEb(categoryId, controllerId, 0);
        }
